...
const mockWardrobe: ClothingItem[] = [
  { _id: '1', name: 'White T-Shirt', category: 'tops', color: 'white', brand: 'Uniqlo' },
  { _id: '2', name: 'Blue Jeans', category: 'bottoms', color: 'blue', brand: "Levi's" },
  { _id: '3', name: 'Black Sneakers', category: 'shoes', color: 'black', brand: 'Nike' },
  { _id: '4', name: 'Leather Jacket', category: 'tops', color: 'black', brand: 'Zara' },
  { _id: '5', name: 'Khaki Chinos', category: 'bottoms', color: 'beige', brand: 'Gap' },
];

const categories: ClothingItem['category'][] = ['tops', 'bottoms', 'shoes', 'accessories'];
const colors = ['white', 'black', 'blue', 'red', 'green', 'beige', 'gray', 'navy'];
  ...
  const deleteItem = (id: string) => {
    Alert.alert('Delete Item', 'Are you sure?', [
      { text: 'Cancel', style: 'cancel' },
      {
        text: 'Delete',
        style: 'destructive',
        onPress: () => setItems(items.filter((i) => i._id !== id)),
      },
    ]);
  };
              ...
              {catItems.map((item) => (
                <View key={item._id} style={styles.itemCard}>
                  <View style={styles.itemInfo}>
                    ...
                    <Text style={styles.itemDetails}>{item.brand} • {item.color}</Text>
                  </View>
...
const styles = StyleSheet.create({
  ...
  categoryTitle: { color: '#fff', fontSize: 18, fontWeight: '600', marginBottom: 10 },
  itemCard: {
